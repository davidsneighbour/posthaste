...
name: posthaste
title: Posthaste
description: Route the Posthaste social publishing skillset. Use when the user wants to draft, adapt, review, or publish social media content with Posthaste, especially when choosing between link preparation, hashtag generation, and social network credential helper skills.
---
